...
?>
<h1 class='text-rose-600'><?php echo __( 'Welcome to Admin Page', 'wpui-menu-page' ); ?></h1>
<section class="container mx-auto p-10 md:py-20 px-0 md:p-10 md:px-0">
    <section class="p-5 md:p-0 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10">
        <article class="p-10 min-h-116 max-w-xl w-full bg-gray-200 rounded-xl text-gray-600 transform duration-500 hover:-translate-y-1 cursor-pointer">
            <h1 class="mt-5 text-2xl md:text-3xl font-light leading-snug min-h-33"><?php _e('One small step for man one giant leap for mankind', 'wpui-menu-page'); ?></h1>
            <div class="mt-20">
                <span class="text-xl"><?php esc_html_e( 'Moonlanding', 'wpui-menu-page' ); ?> - </span>
                <p class="font-bold text-xl">
                    <?php
                        // translators: %s author name
                        echo sprintf( __( 'Author: %s', 'wpui-menu-page' ), $author );
                    ?>
                </p>
            </div>
            <div class="mt-16 flex justify-between">
                <span class="p-3 pl-0 font-bold"><?php echo _n( 'Story', 'Storys', $count, 'wpui-menu-page' ); ?></span>
                <span class="p-3  border-2 border-gray-500 rounded-md text-base hover:bg-black hover:border-gray-200 cursor-pointer hover:text-white "><?php _ex( 'Paid Membership', 'Type of membership', 'wpui-menu-page' ); ?></span>
            </div>
        </article>
